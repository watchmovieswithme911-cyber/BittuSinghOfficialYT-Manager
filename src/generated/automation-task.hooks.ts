...
/**
 * Hooks for AutomationTask routes
 */
export interface AutomationTaskHooks {
  /**
...
/**
 * Default AutomationTask hooks (customize as needed)
 */
export const automationTaskHooks: AutomationTaskHooks = {
