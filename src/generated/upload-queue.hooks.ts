...
/**
 * Hooks for UploadQueue routes
 */
export interface UploadQueueHooks {
  /**
...
/**
 * Default UploadQueue hooks (customize as needed)
 */
export const uploadQueueHooks: UploadQueueHooks = {
