...
import type { CommentHooks } from "./comment.hooks"
...
const WRITABLE_SCALAR_FIELDS = ["videoTitle", "author", "content", "sentiment", "status", "publishedAt", "createdAt", "updatedAt"] as const
 ...
 */
export function createCommentRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Comment not found" } }, 404)
      }
