...
/**
 * Hooks for AnalyticsSnapshot routes
 */
export interface AnalyticsSnapshotHooks {
  /**
...
/**
 * Default AnalyticsSnapshot hooks (customize as needed)
 */
export const analyticsSnapshotHooks: AnalyticsSnapshotHooks = {
