...
/**
 * Hooks for ContentScript routes
 */
export interface ContentScriptHooks {
  /**
...
/**
 * Default ContentScript hooks (customize as needed)
 */
export const contentScriptHooks: ContentScriptHooks = {
